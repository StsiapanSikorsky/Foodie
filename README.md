# Foodie
Foodie - это микросервисная платформа для регистрации ресторанов и бронирования в них столиков. Проект построен на Spring Boot 4 с использованием Eureka, API Gateway, JWT-аутентификации и кеширования в Redis.
